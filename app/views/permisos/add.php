...
<div class="row">
    <div class="col-12 col-md-8 mx-auto">
        <div class="card card-body bg-light mt-3 mt-md-5">
            ...
            <p class="text-muted">Cree un nuevo permiso que pueda asignarse a los roles.</p>
            
            <form action="<?php echo URLROOT; ?>/permisos/add" method="post">
                ...
                <div class="form-group">
                    ...
                    <small class="form-text text-muted">Use el formato: modulo.accion</small>
                </div>
                ...
                <div class="row mt-4 g-2">
                    <div class="col-12 col-md-6">
                        <input type="submit" value="Crear Permiso" class="btn btn-success btn-block w-100">
                    </div>
                    <div class="col-12 col-md-6">
